...
const ANIME_IMAGES = {
  ...
  left: "https://www.citypng.com/public/uploads/preview/sukuna-anime-jujutsu-kaisen-character-hd-png-7040816946829519eyzofqncs.png?v=2025083013",
    ...
    <div ref={containerRef} className="absolute inset-0 z-50 overflow-hidden flex items-center justify-center pointer-events-none">
      ...
      {data.vibe === VibeType.ANIME && (
          <div className="relative w-full h-full flex flex-col items-center justify-center bg-zinc-950 anime-bg opacity-0 overflow-hidden">
             ...
             {/* Logo */}
             <div className="absolute top-1/4 opacity-0 z-20 anime-logo pointer-events-none mix-blend-screen">
                 <img src={ANIME_IMAGES.logo} alt="Logo" className="w-64 h-auto object-contain opacity-50" />
             </div>
